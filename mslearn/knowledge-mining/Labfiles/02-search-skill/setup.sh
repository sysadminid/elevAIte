...
subscription_id="e032d7bd-deba-452a-aff4-acd44e3c4d96"
resource_group="sofyan-resource-group"
location="East US 2"
...
# Retrieve the storage account key for key1 using a direct query and TSV output format.
